...
public class Mail {
     ...
     * Mail.envelop because envelop is public st0atic class ..
     */
    ...
    static class EnvelopJob implements Runnable {
        ...
        public void run() {
            ...
            // Here we get info from our conf/mail.conf.plugin file ...
            final Configuration root = Configuration.root();
           // final String mailFrom = root.getString("mail.from");
            final String mailFrom = root.getString("mail.smtp.user");
            ...
            // Here we send mail to contact list ... 
            ...
            Logger.debug("Mail sent - SMTP:" + root.getString("mail.smtp.host")
                    + ":" + root.getString("mail.smtp.port")
                    + " SSL:" + root.getString("mail.smtp.channel")
                    + " user:" + root.getString("mail.smtp.user")
                    + " password:" + root.getString("mail.smtp.pass"));
        }
    }
}
